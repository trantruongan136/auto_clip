      ...
      <div className="modal-content">
        ...
        <div className="modal-header">
          ...
          <div className="header-text">
            ...
            <Text className="modal-subtitle">Combine featured snippets into a themed collection</Text>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-item">
            ...
            <TextArea
              placeholder="Please enter a collection description (optional)"
              value={summary}
            ...
            <div className="clips-selection">
              <div className="selection-header">
                <Text className="selection-info">
                  Selected {selectedClips.length} fragments
                </Text>
                  ...
                  >
                    ...
                    <div className="clip-content">
                      <div className="clip-title">
                        {clip.generated_title || clip.title || 'unnamed fragment'}
                      </div>
